...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "Tpccoin " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"tpccointools.com", "13.127.12.215"},
    
    {NULL, NULL}
};

static const char *strTestNetDNSSeed[][2] = {
    {"tpccointools.com", "testnet-seed.tpccointools.com"},
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. Tpccoin is probably already running."), addrBind.ToString().c_str());
        else
